Bahmni.ConceptSet.FormConditions.rules = {      //This is a constant that Bahmni expects
    ...
    '12m PTO, 12 month post treatment Outcome': function (formName, formFieldValues) {
        var conceptToEnable_dateOfDeath = "12m PTO, Date of death post treatment";
        var conceptToEnable_causeOfDeath = "12m PTO, Cause of death post treatment";
        var conceptToEnable_reason = "12m PTO, Reasons for no post treatment followup";
        var conceptToEnable_commentsOnNoFup = "12m PTO, Comments on no post treatment followup";
        var conceptToEnable_transfer = "12m PTO, Transfer out post treatment?";
        var conditions = {enable: [], disable: []};
        var conditionConcept = formFieldValues['12m PTO, 12 month post treatment Outcome'];
        var conceptToEnable_surgeryType = "12m PTO, Type of surgery related to post treatment death";
        var conceptToEnable_nonTBCauseOfDeath = "12m PTO, Non TB cause of post treatment death";
        ...
        var conceptToEnable_otherReason = "12m PTO, Other reasons for no post treatment followup";
        ...
        var conceptToEnable_onYes = "12m PTO, If YES, transferred to where post treatment?";
        var conceptToEnable_onNo = "12m PTO, If NO, other reasons for no post treatment followup";
    ...
    '12m PTO, Cause of death post treatment': function (formName, formFieldValues) {
        var conceptToEnable_surgeryType = "12m PTO, Type of surgery related to post treatment death";
        var conceptToEnable_nonTBCauseOfDeath = "12m PTO, Non TB cause of post treatment death";
        var conditions = {enable: [], disable: []};
        var conditionConcept = formFieldValues['12m PTO, Cause of death post treatment'];
        if (conditionConcept == "Surgery related death") {
            conditions.enable.push(conceptToEnable_surgeryType)
        } else {
            conditions.disable.push(conceptToEnable_surgeryType)
    ...
    '12m PTO, Reasons for no post treatment followup': function (formName, formFieldValues) {
        var conceptToEnable = "12m PTO, Other reasons for no post treatment followup";
        var conditions = {enable: [], disable: []};
        var SAETerm = formFieldValues['12m PTO, Reasons for no post treatment followup'];
        if (SAETerm != null) {
            if (SAETerm.indexOf("Other") != -1) {
                conditions.enable.push(conceptToEnable)
            } else {
    ...
    '12m PTO, Transfer out post treatment?': function (formName, formFieldValues) {
        var conceptToEnable_onYes = "12m PTO, If YES, transferred to where post treatment?";
        var conceptToEnable_onNo = "12m PTO, If NO, other reasons for no post treatment followup";
        var conditions = {enable: [], disable: []};
        var conditionConcept = formFieldValues['12m PTO, Transfer out post treatment?'];
        if (conditionConcept == 'True') {
            conditions.enable.push(conceptToEnable_onYes)
        } else {
            conditions.disable.push(conceptToEnable_onYes)
